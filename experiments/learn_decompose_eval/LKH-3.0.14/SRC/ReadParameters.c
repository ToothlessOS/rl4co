...
void ReadParameters(void)
{
    ...
    ProblemFileName = PiFileName = InputTourFileName =
        OutputTourFileName = TourFileName = IntermediateTourFileName = 0;
    ...
    while ((Line = ReadLine(ParameterFile))) {
        ...
        } else if (!strcmp(Keyword, "INTERMEDIATE_TOUR_FILE")) {
            if (!(IntermediateTourFileName = GetFileName(0)))
                eprintf("INTERMEDIATE_TOUR_FILE: string expected");
